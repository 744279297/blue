package com.example.zhangchi.blue.util;
    ...
    static public boolean pair(String strAddr, String strPsw) {
        ...
        if (device.getBondState() != BluetoothDevice.BOND_BONDED) {
            try {
                ...
                boolean flag1 = BluetoothUtil.setPin(device.getClass(), device, strPsw); // 手机和蓝牙采集器配对
                boolean flag2 = BluetoothUtil.createBond(device);
//                remoteDevice = device; // 配对完毕就把这个设备对象传给全局的remoteDevice
            ...
            try {
                BluetoothUtil.removeBond(device.getClass(), device);
