...
public class WaterVIew extends View {
     ...
     *
     */
    public WaterVIew setAmplitude(int a) {
        this.a = a;
        return this;
    }
     ...
     * @param w 默认为0.5
     */
    public WaterVIew setPalstance(float w) {
        this.w = w;
        return this;
    }
     ...
     * @param ms 默认为4毫秒
     */
    public WaterVIew setRefreshTime(int ms) {
        this.ms = ms;
        return this;
    }
    ...
    public WaterVIew setWaveSpeed(int k) {
        this.k = k;
        return this;
    }

    public WaterVIew setWaveColor(int color) {
